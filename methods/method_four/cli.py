...
from methods.method_four.tasks import PrepareVisualizationsAgentCritic
...
def main(args=None):
    ...
    :param str learning_rate: learning rate for the custom Actor-Critic Keras model
    :returns: save and print out the visualizations of the results after training
    """
    args = parser.parse_args()
    build(
        [
            PrepareVisualizationsAgentCritic(
